<head>
    ...
    <title>Smile Digital   @yield('title')</title>
        ...
        <footer>
            ...
            <div class="container-footer">
              ...
              <div class="container-social">
                <a href="{{route('en.terms')}}"> Terms and Conditions</a>
                <br />
                <a href="{{route('en.policy')}}"> privacy policy</a>
                <br />
                <br />
                <p>Connect us</p>
                <div class="social">
              ...
              <div class="container-img">
                ...
                <p>
                  Extended experience, distinguished services, and wide spread,
                   the leading marketing and consulting company in the field
                </p>
              </div>
            </div>
          </footer>
