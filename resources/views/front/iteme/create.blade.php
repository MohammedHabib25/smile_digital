...
<div class="navbar">
  <ul>
    ...
    <li><a href="{{route('iteme.create')}}" class="active">اطلب خدمة</a></li>
  </ul>
</div>
@endsection
@section('content')
    ...
    <div class="landing" id="home">
      <div class="container">
        <div class="title-service-requestserc">
          <h1> اطلب خدمة</h1>
          <p>
            نقدم حلولاً ناجحة فائقة الاداء تضفً قيمة هائلة إلى عمالئنا في دولة 
            االأمارات ودول الخلٌيج و للعالم ونعمل مع عدد كبير من المؤسسات المرموقة,نسعى لتطوير مشاريعكم والمساعده في انتشارها وان نكون الشركة الرائده في مجال التسويق الالكتروني من خلال تقديم افضل الخدمات بمساعدة فريق ذو خبره طويله في هذا المجال.
          </p>
        </div>
